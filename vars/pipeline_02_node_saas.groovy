            ...
            stage('Deployed') {
                steps {
                    script {
                        sh """
                        #!/bin/bash
                        gsutil cp gs://${GCS_BUCKET}/${PROJECT_ID}/${GCP_REPOSITORY}/ /ooredoo-api-test/deployment.yaml .               
                        ...
                        gsutil mv deployment-${BUILD_NUMBER}.yaml gs://${GCS_BUCKET}/${PROJECT_ID}/${GCP_REPOSITORY}/ooredoo-api-test  
                        """
                    }
                }
                post {
